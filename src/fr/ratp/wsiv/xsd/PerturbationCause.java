...
/**
 * <p>Java class for PerturbationCause complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PerturbationCause">
 *   &lt;complexContent>
...
@XmlType(name = "PerturbationCause", propOrder = {
    "id",
    "name",
    "parentId",
    "parentName"
})
public class PerturbationCause {
    ...
    @XmlElementRef(name = "parentId", namespace = "http://wsiv.ratp.fr/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> parentId;
    @XmlElementRef(name = "parentName", namespace = "http://wsiv.ratp.fr/xsd", type = JAXBElement.class, required = false)
